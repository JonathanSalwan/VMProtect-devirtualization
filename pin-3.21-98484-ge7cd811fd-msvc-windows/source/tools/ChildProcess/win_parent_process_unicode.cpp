...
int main(int argc, char* argv[])
{
    ...
    cout << "First UnicodeCreated Process was created successfully!" << endl;
    ...
    cout << "Second UnicodeCreated Process was created successfully!" << endl;
    ...
    cout << "Third UnicodeCreated Process was created successfully!" << endl;
