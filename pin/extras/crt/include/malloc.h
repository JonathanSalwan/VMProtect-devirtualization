...
# define ALLOC_SIZE_2(x,y) __attribute__((alloc_size(x,y)))
#else
# define ALLOC_SIZE(x)
# define ALLOC_SIZE_2(x,y)
#endif

extern void* malloc(size_t byte_count) __mallocfunc __wur ALLOC_SIZE(1);
extern void* calloc(size_t item_count, size_t item_size) __mallocfunc __wur ALLOC_SIZE_2(1,2);
extern void* realloc(void* p, size_t byte_count) __wur ALLOC_SIZE(2);
extern void *valloc(size_t size) __mallocfunc __wur ALLOC_SIZE(1);
extern void free(void* p);

extern void* memalign(size_t alignment, size_t byte_count) __mallocfunc __wur ALLOC_SIZE(2);
