...
#ifdef __APPLE__
typedef bool (*unw_find_macho_unwind_sections_fn)(uintptr_t target_addr,
                                                  uintptr_t* dso_base, uintptr_t* compact_unwind_section,
                                                  uintptr_t* compact_unwind_section_length, uintptr_t* dwarf_section,
                                                  uintptr_t* dwarf_section_length);
#endif
#ifdef __linux__
typedef bool (*unw_find_elf_unwind_sections_fn)(uintptr_t target_addr,
                                                uintptr_t* dso_base, uintptr_t* dwarf_index_section,
                                                uintptr_t* dwarf_index_section_length, uintptr_t* dwarf_section,
                                                uintptr_t* dwarf_section_length);
#endif
...
#ifdef __APPLE__
extern void unw_set_find_macho_unwind_sections_fn(unw_find_macho_unwind_sections_fn fn);
#endif
#ifdef __linux__
extern void unw_set_find_elf_unwind_sections_fn(unw_find_elf_unwind_sections_fn fn);
#endif
...
// This part of the code is different than the original libunwind
// Code from LLVM:
// It turns out that Clang on OS X* generates unwind information with different
// register name constants than GCC.
#ifdef __APPLE__
enum {
  UNW_X86_EAX = 0,
  UNW_X86_ECX = 1,
